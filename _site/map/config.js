...
let divChapter1 =
  ...
  '<p class="code tl lh-copy f6">In 2019 more than 300 WARN notices were submitted New York State\'s Department of Labor, with almost 50% percent of those located outside New York City. In the north-west of the state, more than 50 notices came from Rochester, Buffalo, or Syracuse, while in the east more than 40 came from Long Island. New York accounted for almost 180 notices that year.</p>' +
...
let divChapter2 =
  ...
  '<p class="code tl lh-copy f6">2020 was, of course, a different kind of year. Mainly because of the COVID-19 pandemic, WARN notices in the state of New York increase almost 7-fold, with more than 2,300 notices being filed from nearly every corner of the state.<br><br>For example, the number of WARN notices from the region around Rochester, Buffalo and Syracuse increased by more than 300%, while the ones coming from Long Island increased by more than 500%. The number of notices coming from Albany and its surroundings, which in 2019 numbered only 7, went up to 50.</p>' +
...
let divChapter3 =
  ...
  '<p class="code tl lh-copy f6">But of course the brunt of WARN notices for 2020 were submitted by businesses in New York City. From 170 notices in 2019, the city jumped to more than 1,500, a 8-fold increase. And according to these notices, more than 170,000 people where laid off in New York City in 2020.</p>' +
...
let divChapter4 =
  '<div class="ph4 pt3 pb4"><p class="avenir tl f4">MANHATTAN - THE HARDEST HIT</p>' +
  '<p class="code tl lh-copy f6">More than 80% of the notices submitted in 2020 came from businesses in Manhattan, with Midtown and Downtown as the most affected neighborhoods. Brooklyn and Queens accounted for only 7% and 10% respectively, and the Bronx and Staten Island for an even smaller share. Similarly, Manhattan businesses submitted WARN notices affecting more than 130,000 people, while the other four boroughs combined only accounted for less than 40,000.</p>' +
  '<img src="./img/boroughChart.svg" class="w-100 pt0 mt3" alt="Bar chart of number of notices and people affected in New York City"></div>';

let divChapter5 =
  '<div class="ph4 pt3 pb4"><p class="avenir tl f4">OUR SELECTED SLICE OF THE CITY</p>' +
  '<p class="code tl lh-copy f6">To illustrate how dire the situation is for certain parts of the city we have chosen to focus on a section of the city between 42nd street and Central Park South and between Lexington and 8th Avenues. This slice of the city contains more than 250 businesses that submitted WARN notices, affecting more than 40,000 people. Most of the businesses here are hotels and restaurants, but there are also quite a few theater and entertainment related businesses, as well as retail stores.</p></div>';
