...
let description =
  ...
  '<p class="avenir tl f4 mw6 center mt4 lh-copy">Note that in New York State only businesses with 50 or more employees are required to submit WARN notices, and therefore this data cannot account for the hundreds of small businesses affected by the pandemic.</p>' +
  '<p class="avenir tc f4 mw6 center mt4 lh-copy">Scroll to continue<br>▼</p>';

let divChapter1 =
  '<div class="pa4"><p class="avenir tl f4">WARN NOTICES IN 2019</p>' +
...
let divChapter2 =
  '<div class="pa4"><p class="avenir tl f4">2020 AND THE PANDEMIC</p>' +
...
let divChapter3 =
  '<div class="pa4"><p class="avenir tl f4">2020 WARN NOTICES IN NEW YORK CITY</p>' +
...
let divChapter4 =
  '<div class="pa4"><p class="avenir tl f4">(placeholder) Building footprints</p>' +
...
let divChapter5 =
  '<div class="pa4"><p class="avenir tl f4">(placeholder) Our selected slice of the city</p>' +
